...
import com.example.a10767.electronic_wardrobe.Clothes_Manage.Cap_Add;
...
public class Clothe_Cap extends AppCompatActivity implements View.OnClickListener {
    private ListView mListView;
    private String cap_url; //地址
    private static final String TAG = "Clothe_Jacket";
    private LinearLayout cap_return; //返回
    private Button cap_add; //添加
    private Button cap_search; //调查
    private Button cap_manage; //管理
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SUCCESS_SHOW:
                    new NewsAsyncTask().execute(cap_url);
                    break;
                case ERROR_SHOW:
                    progressDialog.dismiss();
                    Toast.makeText(Clothe_Cap.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clothe_cap);
        mListView = findViewById(R.id.cap_listView);
        initUI();
        initView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        themain = 1;
        startActivity(new Intent(Clothe_Cap.this, TheMain.class));
    ...
    private void initView() {
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                startActivity(new Intent(Clothe_Cap.this, Clothes_Check.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
            }
        });
        cap_add.setOnClickListener(this);
        cap_return.setOnClickListener(this);
        cap_search.setOnClickListener(this);
        cap_manage.setOnClickListener(this);
    }

    private void initUI() {
        clo_name = "帽子";
        progressDialog = new ProgressDialog(Clothe_Cap.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        cap_search=findViewById(R.id.cap_search);
        cap_manage = findViewById(R.id.cap_manage);
        cap_add = findViewById(R.id.cap_add);
        cap_return = findViewById(R.id.cap_return);
    }
...
/*===============================接受数据======================================================*/
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.cap_add:
                startActivity(new Intent(Clothe_Cap.this, Cap_Add.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
            case R.id.cap_return:
                themain = 1;
                startActivity(new Intent(Clothe_Cap.this, TheMain.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.cap_manage:
                startActivity(new Intent(Clothe_Cap.this, Clothes_Delete.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
            case R.id.cap_search:
                startActivity(new Intent(Clothe_Cap.this, Clothes_Search.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
        }
    }
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(List<Clothes> clothes) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Clothe_Cap.this, clothes);
            progressDialog.dismiss();
    ...
    private void receiveClothes() {
        progressDialog.show();
          /*接受数据*/
        OkHttpUtil.postJson_showClothes(url + "LoginTest2/findUserClothesBegin.action", login_account_Ed, "帽子", new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                cap_url = response.body().string();
                Log.d(TAG, "地址:" + cap_url);
