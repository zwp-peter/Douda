...
public class Register extends AppCompatActivity implements View.OnClickListener {
    ...
    private void submit() {
        ...
        String register_password_Ed = pref.getString("register_password_Ed", "");
        String register_find_phoneNumber_Ed = pref.getString("register_find_phoneNumber_Ed", "");
        OkHttpUtil.okhttputil_register(url + "LoginTest2/register.action", register_account_Ed,
                register_password_Ed, register_find_phoneNumber_Ed, new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                handler.sendEmptyMessage(NET_ERROR);
            }
