...
public class Others_Skirt extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "Mix_Jacket";
    private String jacket_url; //地址
    private ProgressDialog progressDialog; //等待
    private LinearLayout others_skirt_return; //返回
    private Button others_skirt_search; //查找
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ERROR_SHOW:
                    ...
                    Toast.makeText(Others_Skirt.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.others_skirt);
        initUI();
        initView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Others_Skirt.this,Others_Wardrobe_Choice.class));
    ...
    private void initView() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            startActivity(new Intent(Others_Skirt.this, Others_Add.class));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
        ...
        others_skirt_search.setOnClickListener(this);
        others_skirt_return.setOnClickListener(this);

    }


    private void initUI() {
        progressDialog = new ProgressDialog(Others_Skirt.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        mListView = findViewById(R.id.others_skirt_listView);
        others_skirt_return = findViewById(R.id.others_skirt_return);
        others_skirt_search = findViewById(R.id.others_skirt_search);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.others_skirt_return:
                startActivity(new Intent(Others_Skirt.this,Others_Wardrobe_Choice.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.others_skirt_search:
    ...
    private void receiveClothes() {
        progressDialog.show();
          /*接受数据*/
        OkHttpUtil.postJson_showClothes(url + "LoginTest2/findUserClothesBegin.action", login_account_Ed, "裙子", new Callback() {
            @Override
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(final List<Clothes> list) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Others_Skirt.this, list);
            progressDialog.dismiss();
