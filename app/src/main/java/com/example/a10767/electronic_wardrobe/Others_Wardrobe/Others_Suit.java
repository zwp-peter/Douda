...
public class Others_Suit extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "Mix_Jacket";
    private String jacket_url; //地址
    private ProgressDialog progressDialog; //等待
    private LinearLayout others_suit_return; //返回
    private Button others_suit_search; //查找
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ERROR_SHOW:
                    ...
                    Toast.makeText(Others_Suit.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.others_suit);
        initUI();
        initView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Others_Suit.this,Others_Wardrobe_Choice.class));
    ...
    private void initView() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            startActivity(new Intent(Others_Suit.this, Others_Add.class));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
        ...
        others_suit_search.setOnClickListener(this);
        others_suit_return.setOnClickListener(this);

    }


    private void initUI() {
        progressDialog = new ProgressDialog(Others_Suit.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        mListView = findViewById(R.id.others_suit_listView);
        others_suit_return = findViewById(R.id.others_suit_return);
        others_suit_search = findViewById(R.id.others_suit_search);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.others_suit_return:
                startActivity(new Intent(Others_Suit.this,Others_Wardrobe_Choice.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.others_suit_search:
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(final List<Clothes> list) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Others_Suit.this, list);
            progressDialog.dismiss();
