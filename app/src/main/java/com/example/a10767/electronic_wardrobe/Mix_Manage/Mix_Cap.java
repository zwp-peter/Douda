...
/***
 *  搭配裤子衣柜（目前只有点击事件，查询没有）
 */

public class Mix_Cap extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "Mix_Jacket";
    private String jacket_url; //地址
    private ProgressDialog progressDialog; //等待
    private LinearLayout mix_cap_return; //返回
    private Button mix_cap_search; //查找
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ERROR_SHOW:
                    ...
                    Toast.makeText(Mix_Cap.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mix_cap);
        initUI();
        initView();
        receiveClothes(); //接受数据
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Mix_Cap.this, Wardrobe_choice.class));
    ...
    private void initView() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            startActivity(new Intent(Mix_Cap.this, Frame_All.class));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
        ...
        mix_cap_search.setOnClickListener(this);
        mix_cap_return.setOnClickListener(this);

    }


    private void initUI() {
        progressDialog = new ProgressDialog(Mix_Cap.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        mListView = findViewById(R.id.mix_cap_listView);
        mix_cap_return = findViewById(R.id.mix_cap_return);
        mix_cap_search = findViewById(R.id.mix_cap_search);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.mix_cap_return:
                startActivity(new Intent(Mix_Cap.this, Wardrobe_choice.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.mix_cap_search:
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(final List<Clothes> list) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Mix_Cap.this, list);
            progressDialog.dismiss();
