...
import com.example.a10767.electronic_wardrobe.Clothes_Manage.Suit_Add;
...
public class Clothe_Suit extends AppCompatActivity implements View.OnClickListener {
    private ListView mListView;
    private String suit_url; //地址
    private static final String TAG = "Clothe_Skirt";
    private LinearLayout suit_return; //返回
    private Button suit_add; //添加
    private Button suit_manage;
    private Button suit_search; //查询
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SUCCESS_SHOW:
                    new NewsAsyncTask().execute(suit_url);
                    break;
                case ERROR_SHOW:
                    progressDialog.dismiss();
                    Toast.makeText(Clothe_Suit.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clothe_suit);
        mListView = findViewById(R.id.suit_listView);
        initUI();
        initView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        themain = 1;
        startActivity(new Intent(Clothe_Suit.this, TheMain.class));
    ...
    private void initView() {
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                startActivity(new Intent(Clothe_Suit.this, Clothes_Check.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
            }
        });
        suit_add.setOnClickListener(this);
        suit_manage.setOnClickListener(this);
        suit_return.setOnClickListener(this);
        suit_search.setOnClickListener(this);
    }

    private void initUI() {
        clo_name = "套装";
        progressDialog = new ProgressDialog(Clothe_Suit.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        suit_search=findViewById(R.id.suit_search);
        suit_return = findViewById(R.id.suit_return);
        suit_add = findViewById(R.id.suit_add);
        suit_manage = findViewById(R.id.suit_manage);
    }
...
/*===============================接受数据======================================================*/
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.suit_add:
                startActivity(new Intent(Clothe_Suit.this, Suit_Add.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
            case R.id.suit_return:
                themain = 1;
                startActivity(new Intent(Clothe_Suit.this, TheMain.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.suit_manage:
                startActivity(new Intent(Clothe_Suit.this, Clothes_Delete.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
            case R.id.suit_search:
                startActivity(new Intent(Clothe_Suit.this, Clothes_Search.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
        }
    }
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(List<Clothes> clothes) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Clothe_Suit.this, clothes);
            progressDialog.dismiss();
    ...
    private void receiveClothes() {
        ...
        OkHttpUtil.postJson_showClothes(url + "LoginTest2/findUserClothesBegin.action", login_account_Ed, "套装", new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                suit_url = response.body().string();
                Log.d(TAG, "地址:" + suit_url);
