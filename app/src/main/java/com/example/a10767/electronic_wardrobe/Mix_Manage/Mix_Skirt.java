...
public class Mix_Skirt extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "Mix_Jacket";
    private String skirt_url; //地址
    private ProgressDialog progressDialog; //等待
    private LinearLayout mix_skirt_return; //返回
    private Button mix_skirt_search; //查找
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ERROR_SHOW:
                    ...
                    Toast.makeText(Mix_Skirt.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mix_skirt);
        initUI();
        initView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Mix_Skirt.this, Wardrobe_choice.class));
    ...
    private void initView() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            startActivity(new Intent(Mix_Skirt.this, Frame_All.class));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
        ...
        mix_skirt_search.setOnClickListener(this);
        mix_skirt_return.setOnClickListener(this);

    }


    private void initUI() {
        progressDialog = new ProgressDialog(Mix_Skirt.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        mListView = findViewById(R.id.mix_skirt_listView);
        mix_skirt_return = findViewById(R.id.mix_skirt_return);
        mix_skirt_search = findViewById(R.id.mix_skirt_search);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.mix_skirt_return:
                startActivity(new Intent(Mix_Skirt.this, Wardrobe_choice.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.mix_skirt_search:
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(final List<Clothes> list) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Mix_Skirt.this, list);
            progressDialog.dismiss();
