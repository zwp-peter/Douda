...
import com.example.a10767.electronic_wardrobe.Clothes_Manage.Accessories_Add;
...
public class Clothe_Accessories extends AppCompatActivity implements View.OnClickListener {
    private ListView mListView;
    private String accessories_url; //地址
    private static final String TAG = "Clothe_Jacket";
    private LinearLayout accessories_return; //返回
    private Button accessories_add; //添加
    private Button accessories_search; //查找
    private Button accessories_manage; //管理
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SUCCESS_SHOW:
                    new NewsAsyncTask().execute(accessories_url);
                    break;
                case ERROR_SHOW:
                    progressDialog.dismiss();
                    Toast.makeText(Clothe_Accessories.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clothe_accessories);
        mListView = findViewById(R.id.accessories_listView);
        initUI();
        initView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        themain = 1;
        startActivity(new Intent(Clothe_Accessories.this, TheMain.class));
    ...
    private void initView() {
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                startActivity(new Intent(Clothe_Accessories.this, Clothes_Check.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
            }
        });
        accessories_search.setOnClickListener(this);
        accessories_return.setOnClickListener(this);
        accessories_add.setOnClickListener(this);
        accessories_manage.setOnClickListener(this);
    }

    private void initUI() {
        clo_name = "饰品";
        progressDialog = new ProgressDialog(Clothe_Accessories.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        accessories_search=findViewById(R.id.accessories_search);
        accessories_manage = findViewById(R.id.accessories_manage);
        accessories_add = findViewById(R.id.accessories_add);
        accessories_return = findViewById(R.id.accessories_return);
    }
...
/*===============================接受数据======================================================*/
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.accessories_add:
                startActivity(new Intent(Clothe_Accessories.this, Accessories_Add.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
            case R.id.accessories_return:
                themain = 1;
                startActivity(new Intent(Clothe_Accessories.this, TheMain.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.accessories_manage:
                startActivity(new Intent(Clothe_Accessories.this, Clothes_Delete.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
            case R.id.accessories_search:
                startActivity(new Intent(Clothe_Accessories.this, Clothes_Search.class));
                overridePendingTransition(R.anim.enter, R.anim.quit);
                break;
        }
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(List<Clothes> clothes) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Clothe_Accessories.this, clothes);
            progressDialog.dismiss();
    ...
    private void receiveClothes() {
        progressDialog.show();
          /*接受数据*/
        OkHttpUtil.postJson_showClothes(url + "LoginTest2/findUserClothesBegin.action", login_account_Ed, "饰品", new Callback() {
            @Override
            ...
            public void onResponse(Call call, Response response) throws IOException {
                accessories_url = response.body().string();
                Log.d(TAG, "地址:" + accessories_url);
