...
public class Others_Jacket extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "Mix_Jacket";
    private String jacket_url; //地址
    private ProgressDialog progressDialog; //等待
    private LinearLayout others_jacket_return; //返回
    private Button others_jacket_search; //查找
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ERROR_SHOW:
                    ...
                    Toast.makeText(Others_Jacket.this, "网络连接错误", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.others_jacket);
        initUI();
        initView();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Others_Jacket.this,Others_Wardrobe_Choice.class));
    ...
    private void initView() {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            startActivity(new Intent(Others_Jacket.this, Others_Add.class));
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
        ...
        others_jacket_search.setOnClickListener(this);
        others_jacket_return.setOnClickListener(this);

    }


    private void initUI() {
        progressDialog = new ProgressDialog(Others_Jacket.this);
        progressDialog.setMessage("加载中....");
        progressDialog.setCancelable(false);
        mListView = findViewById(R.id.others_jacket_listView);
        others_jacket_return = findViewById(R.id.others_jacket_return);
        others_jacket_search = findViewById(R.id.others_jacket_search);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.others_jacket_return:
                startActivity(new Intent(Others_Jacket.this,Others_Wardrobe_Choice.class));
                overridePendingTransition(R.anim.enter2, R.anim.quit2);
                break;
            case R.id.others_jacket_search:
    ...
    class NewsAsyncTask extends AsyncTask<String, Void, List<Clothes>> {
        ...
        protected void onPostExecute(final List<Clothes> list) {
            ...
            ClothesAdapter clothesAdapter = new ClothesAdapter(Others_Jacket.this, list);
            progressDialog.dismiss();
